  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type='submit'
          className='group flex items-center justify-center gap-2 h-[3rem] w-[8rem] bg-gray-900 text-white rounded-full outline-none transition-all focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 dark:bg-white dark:text-black dark:hover:text-white dark:bg-opacity-10 disabled:scale-100 disabled:bg-opacity-65 border border-black/10 dark:border-white/20 shadow-lg hover:shadow-xl dark:hover:shadow-2xl mx-auto'
        >
          Submit{' '}
